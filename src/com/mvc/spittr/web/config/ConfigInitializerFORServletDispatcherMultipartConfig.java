...
public class ConfigInitializerFORServletDispatcherMultipartConfig extends AbstractAnnotationConfigDispatcherServletInitializer {
	...
	protected Class<?>[] getRootConfigClasses() {
		logger.info("[{}] AppRootConfig.class config", this.DEFAULT_SERVLET_NAME);
		return new Class<?>[] { AppRootConfig.class }; // RootConfig.class root
														// configuration is
	...
	protected Class<?>[] getServletConfigClasses() {
		logger.info("[{}] AppWebConfig.class config", this.DEFAULT_SERVLET_NAME);
	...
	protected void customizeRegistration(ServletRegistration.Dynamic registration) {
		...
		logger.info("new File({})", SpitterConsts.TEMPDIR.getStr());
		...
		logger.info("[{}] multipart uploads files at {}, maxFileSize={}, maxRequestSize={}, fileSizeThreshold={}",
				this.DEFAULT_SERVLET_NAME, SpitterConsts.DOWNLOAD_PATH.getStr(), SpitterConsts.MAX_FILE_SIZE.getLnum(),
				SpitterConsts.MAX_REQUEST_SIZE.getLnum(), SpitterConsts.FILE_SIZE_THRESHOLD.getNum());
	}
